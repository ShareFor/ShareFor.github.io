...
p.nominalBounds = new cjs.Rectangle(0,0,322,569);
...
(lib.q1btnd = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// 图层 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("EguaAGQIAAsfMBc0AAAIAAMfg");
	this.shape.setTransform(297.1,40);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,594.2,80);


(lib.q1btnc = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// 图层 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("Egu4AGQIAAsfMBdxAAAIAAMfg");
	this.shape.setTransform(300.1,40);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,600.2,80);


(lib.q1btnb = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// 图层 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("EguuAGQIAAsfMBddAAAIAAMfg");
...
(lib.q1btna = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// 图层 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("EguuAGZIAAsyMBddAAAIAAMyg");
	this.shape.setTransform(299.1,41);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,598.2,82);
...
(lib.hover_img = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// 图层 1
	this.instance = new lib._1();
	this.instance.setTransform(-327.5,-583.8,2.035,2.052);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(35));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-327.5,-583.8,655.2,1167.8);
...
(lib.btn_huhuans = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// 图层 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("A2KG4IAAtwMAsVAAAIAANwg");
	this.shape.setTransform(142,44.1);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,283.9,88.2);


(lib.btn_bufus = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// 图层 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("A1jGVIAAspMArHAAAIAAMpg");
	this.shape.setTransform(138,40.5);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,276,81);


(lib.btn_agains = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// 图层 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("EgtJAG4IAAtvMBaSAAAIAANvg");
	this.shape.setTransform(289,44);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,578,88);
...
(lib.tman = function(mode,startPosition,loop) {
	...
	this.frame_30 = function() {
		...
		*/
		this.stop();
		var status=0;
		this.q1btna.addEventListener("click", fl_MouseClickHandler_60.bind(this));
		selected = 0;
		...
		this.q1btnb.addEventListener("click", b.bind(this));
		...
		this.q1btnc.addEventListener("click", c.bind(this));
		...
		this.q1btnd.addEventListener("click", d.bind(this));
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(30).call(this.frame_30).wait(6).call(this.frame_36).wait(10).call(this.frame_46).wait(4).call(this.frame_50).wait(4).call(this.frame_54).wait(11).call(this.frame_65).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.currentmcs).wait(66));

	// q1btn
	this.q1btnd = new lib.q1btnd();
	this.q1btnd.setTransform(263.1,678,1,1,0,0,0,297.1,40);
	this.q1btnd.alpha = 0.012;
	new cjs.ButtonHelper(this.q1btnd, 0, 1, 1);

	this.q1btnc = new lib.q1btnc();
	this.q1btnc.setTransform(266.1,576,1,1,0,0,0,300.1,40);
	this.q1btnc.alpha = 0.012;
	new cjs.ButtonHelper(this.q1btnc, 0, 1, 1);

	this.q1btnb = new lib.q1btnb();
	this.q1btnb.setTransform(265.1,476,1,1,0,0,0,299.1,40);
	this.q1btnb.alpha = 0.012;
	new cjs.ButtonHelper(this.q1btnb, 0, 1, 1);

	this.q1btna = new lib.q1btna();
	this.q1btna.setTransform(265.1,387,1,1,0,0,0,299.1,41);
	this.q1btna.alpha = 0.012;
	new cjs.ButtonHelper(this.q1btna, 0, 1, 1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.q1btna},{t:this.q1btnb},{t:this.q1btnc},{t:this.q1btnd}]},30).wait(36));

	// a
	this.instance = new lib.补间6("synched",0);
	this.instance.setTransform(248,885);
	this.instance._off = true;

	this.instance_1 = new lib.补间7("synched",0);
	this.instance_1.setTransform(246.5,383);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(10).to({_off:false},0).to({_off:true,x:246.5,y:383},9).wait(35).to({_off:false,x:248,y:885},6).to({_off:true},1).wait(5));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(10).to({_off:false},9).wait(35).to({startPosition:0},0).to({_off:true,x:248,y:885},6).wait(6));

	// b
	this.instance_2 = new lib.补间8("synched",0);
	this.instance_2.setTransform(248,870);
	this.instance_2._off = true;

	this.instance_3 = new lib.补间9("synched",0);
	this.instance_3.setTransform(248,472);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(13).to({_off:false},0).to({_off:true,y:472},8).wait(29).to({_off:false,y:870},6).to({_off:true},1).wait(9));
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(13).to({_off:false},8).wait(29).to({startPosition:0},0).to({_off:true,y:870},6).wait(10));

	// c
	this.instance_4 = new lib.补间12("synched",0);
	this.instance_4.setTransform(240,878);
	this.instance_4._off = true;

	this.instance_5 = new lib.补间13("synched",0);
	this.instance_5.setTransform(248,572);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(16).to({_off:false},0).to({_off:true,x:248,y:572},8).wait(22).to({_off:false,x:240,y:878},7).to({_off:true},1).wait(12));
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(16).to({_off:false},8).wait(22).to({startPosition:0},0).to({_off:true,x:240,y:878},7).wait(13));

	// d
	this.instance_6 = new lib.补间14("synched",0);
	this.instance_6.setTransform(238,878);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(19).to({_off:false},0).to({x:246.5,y:675.6},7).wait(16).to({startPosition:0},0).to({x:238,y:878},6).to({_off:true},1).wait(17));
...
(lib.result22 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(149.5,250.5);

	this.instance_1 = new lib.补间51("synched",0);
	this.instance_1.setTransform(149.5,250.5);
...
p.nominalBounds = new cjs.Rectangle(0,-8,299,517);
...
(lib.q4top = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(29).call(this.frame_29).wait(5).call(this.frame_34).wait(4).call(this.frame_38).wait(4).call(this.frame_42).wait(3).call(this.frame_45).wait(18).call(this.frame_63).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.button_14,p:{y:681.5}},{t:this.b_q4},{t:this.c_q4},{t:this.d_q4}]},34).to({state:[{t:this.button_14,p:{y:681.5}},{t:this.b_q4},{t:this.c_q4},{t:this.d_q4}]},4).to({state:[{t:this.button_14,p:{y:681.5}},{t:this.b_q4},{t:this.c_q4},{t:this.d_q4}]},4).to({state:[{t:this.button_14,p:{y:691.1}}]},3).to({state:[{t:this.button_14,p:{y:691.1}}]},18).wait(1));

	// currentmc4
	this.currentmc4 = new lib.currentmc4();
	this.currentmc4.setTransform(63.5,687.5,1,1,0,0,0,35.5,35.5);

	this.timeline.addTween(cjs.Tween.get(this.currentmc4).wait(64));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(16).to({_off:false},0).to({_off:true,y:956},9).wait(9).to({_off:false,y:1190},6).to({_off:true},1).wait(23));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(16).to({_off:false},9).wait(9).to({startPosition:0},0).to({_off:true,y:1190},6).wait(24));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(14).to({_off:false},0).to({_off:true,y:868},8).wait(16).to({_off:false,y:1182},6).to({_off:true},1).wait(19));
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(14).to({_off:false},8).wait(7).to({y:870},0).wait(9).to({y:868},0).to({_off:true,y:1182},6).wait(20));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(12).to({_off:false},0).to({_off:true,y:778},9).wait(21).to({_off:false,y:1190},6).to({_off:true},1).wait(15));
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(12).to({_off:false},9).wait(8).to({y:780},0).wait(13).to({y:778},0).to({_off:true,y:1190},6).wait(16));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(9).to({_off:false},0).to({_off:true,y:689.1},8).wait(28).to({_off:false,y:1184},6).to({_off:true},1).wait(12));
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(9).to({_off:false},8).wait(12).to({y:692},0).wait(16).to({y:689.1},0).to({_off:true,y:1184},6).wait(13));
...
(lib.q3man = function(mode,startPosition,loop) {
	...
	this.frame_34 = function() {
		if(selected==4){
			this.currentmc3s.gotoAndStop(0);
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(29).call(this.frame_29).wait(5).call(this.frame_34).wait(3).call(this.frame_37).wait(4).call(this.frame_41).wait(4).call(this.frame_45).wait(14).call(this.frame_59).wait(1));

	// currentmc3s
	this.currentmc3s = new lib.currentmc3s();
	this.currentmc3s.setTransform(48.5,435.5,1,1,0,0,0,35.5,35.5);

	this.timeline.addTween(cjs.Tween.get(this.currentmc3s).wait(60));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(20).to({_off:false},0).to({y:715.9},9).wait(5).to({startPosition:0},0).to({y:956},5).to({_off:true},1).wait(20));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(15).to({_off:false},0).to({_off:true,y:626},10).wait(12).to({_off:false,y:948},6).to({_off:true},1).wait(16));
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(15).to({_off:false},10).wait(12).to({startPosition:0},0).to({_off:true,y:948},6).wait(17));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(10).to({_off:false},0).to({_off:true,y:534},10).wait(21).to({_off:false,y:950},6).to({_off:true},1).wait(12));
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(10).to({_off:false},10).wait(21).to({startPosition:0},0).to({_off:true,y:950},6).wait(13));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(5).to({_off:false},0).to({_off:true,y:438},10).wait(30).to({_off:false,y:950},6).to({_off:true},1).wait(8));
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(5).to({_off:false},10).wait(30).to({startPosition:0},0).to({_off:true,y:950},6).wait(9));
...
(lib.cover = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(29).call(this.frame_29).wait(8).call(this.frame_37).wait(3).call(this.frame_40).wait(4).call(this.frame_44).wait(4).call(this.frame_48).wait(11).call(this.frame_59).wait(1));
	...
	this.text.lineHeight = 15;
	this.text.lineWidth = 144;
	this.text.setTransform(867.8,-179.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.q2_b},{t:this.q2_c},{t:this.q2_d}]},29).to({state:[{t:this.q2_b},{t:this.q2_c},{t:this.q2_d}]},8).to({state:[{t:this.q2_b},{t:this.q2_c},{t:this.q2_d}]},3).to({state:[{t:this.q2_b},{t:this.q2_c},{t:this.q2_d}]},4).to({state:[{t:this.q2_b},{t:this.q2_c},{t:this.q2_d},{t:this.text,p:{x:867.8,y:-179.7,lineWidth:144}}]},4).to({state:[{t:this.q2_b},{t:this.q2_c},{t:this.q2_d},{t:this.text,p:{x:811.7,y:-255.7,lineWidth:435}}]},11).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.currentmc2).wait(60));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(19).to({_off:false},0).to({_off:true,y:962},10).wait(8).to({_off:false,y:1404},6).to({_off:true},1).wait(16));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(19).to({_off:false},10).wait(8).to({startPosition:0},0).to({_off:true,y:1404},6).wait(17));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(14).to({_off:false},0).to({_off:true,y:870},10).wait(16).to({_off:false,y:1324},6).to({_off:true},1).wait(13));
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(14).to({_off:false},10).wait(16).to({startPosition:0},0).to({_off:true,y:1324},6).wait(14));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(9).to({_off:false},0).to({_off:true,y:782},10).wait(25).to({_off:false,y:1198.1},5).to({_off:true},1).wait(10));
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(9).to({_off:false},10).wait(25).to({startPosition:0},0).to({_off:true,y:1198.1},5).wait(11));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(4).to({_off:false},0).to({y:686.2},9).wait(35).to({startPosition:0},0).to({y:1204.3},5).to({_off:true},1).wait(6));
	...
	this.timeline.addTween(cjs.Tween.get(this.q2man).wait(12).to({_off:false},0).to({y:427.7},10).wait(30).to({y:-232.5},6).to({_off:true},1).wait(1));

	// top
	this.q2top = new lib.q2top();
	this.q2top.setTransform(320,-107,1,1,0,0,0,320,89);

	this.timeline.addTween(cjs.Tween.get(this.q2top).to({y:89},9).wait(39).to({y:-107},7).to({_off:true},1).wait(4));
...
(lib.q5mans = function(mode,startPosition,loop) {
	...
	this.result22.setTransform(207.5,157.3,1,1,0,0,0,149.5,258.5);
	this.result22._off = true;

	this.timeline.addTween(cjs.Tween.get(this.result22).wait(2).to({_off:false},0).to({_off:true},1).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.result44).wait(1).to({_off:false},0).to({_off:true},1).wait(2));

	// result1
	this.result11 = new lib.result11();
	this.result11.setTransform(194,208.5,1,1,0,0,0,194,208.5);

	this.timeline.addTween(cjs.Tween.get(this.result11).to({_off:true},1).wait(3));
...
(lib.lastbg = function(mode,startPosition,loop) {
	...
	this.frame_14 = function() {
		...
		*/
		this.stop();
		this.temp = 0
		this.btn_agains.addEventListener("click", fl_MouseClickHandler_62.bind(this));
		...
		this.btn_bufus.addEventListener("click", bufu.bind(this));
		...
		this.btn_huhuans.addEventListener("click", huhuan.bind(this));
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(1).call(this.frame_1).wait(13).call(this.frame_14).wait(11).call(this.frame_25).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.bufu},{t:this.huhuan}]},25).wait(1));

	// hover
	this.hover_img = new lib.hover_img();
	this.hover_img.setTransform(313.6,583.9);
	this.hover_img._off = true;

	this.timeline.addTween(cjs.Tween.get(this.hover_img).wait(15).to({_off:false},0).wait(11));

	// btn_result
	this.btn_huhuans = new lib.btn_huhuans();
	this.btn_huhuans.setTransform(466.1,960.1,1,1,0,0,0,142,44.1);
	this.btn_huhuans.alpha = 0.051;
	new cjs.ButtonHelper(this.btn_huhuans, 0, 1, 1);

	this.btn_bufus = new lib.btn_bufus();
	this.btn_bufus.setTransform(168,956.5,1,1,0,0,0,138,40.5);
	this.btn_bufus.alpha = 0.051;
	new cjs.ButtonHelper(this.btn_bufus, 0, 1, 1);

	this.btn_agains = new lib.btn_agains();
	this.btn_agains.setTransform(319,848,1,1,0,0,0,289,44);
	this.btn_agains.alpha = 0.051;
	new cjs.ButtonHelper(this.btn_agains, 0, 1, 1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.btn_agains},{t:this.btn_bufus},{t:this.btn_huhuans}]},1).wait(25));

	// hover_right (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_4 = new cjs.Graphics().p("AvHJoIAAzOIeOAAIAATOg");
	var mask_graphics_5 = new cjs.Graphics().p("Au9NJIAA6RId7AAIAAaRg");
	var mask_graphics_6 = new cjs.Graphics().p("AuzQrMAAAghVIdnAAMAAAAhVg");
	var mask_graphics_7 = new cjs.Graphics().p("AuqUMMAAAgoXIdVAAMAAAAoXg");
	var mask_graphics_8 = new cjs.Graphics().p("AugXuMAAAgvbIdBAAMAAAAvbg");
	var mask_graphics_9 = new cjs.Graphics().p("AuWbPMAAAg2dIctAAMAAAA2dg");
	var mask_graphics_10 = new cjs.Graphics().p("AuNexMAAAg9hIcbAAMAAAA9hg");
	var mask_graphics_11 = new cjs.Graphics().p("EgODAiTMAAAhElIcHAAMAAABElg");
	var mask_graphics_12 = new cjs.Graphics().p("EgN6Al0MAAAhLnIb1AAMAAABLng");
	var mask_graphics_13 = new cjs.Graphics().p("EgNwApWMAAAhSrIbhAAMAAABSrg");
	var mask_graphics_14 = new cjs.Graphics().p("EgNnAs4MAAAhZuIbPAAMAAABZug");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(4).to({graphics:mask_graphics_4,x:543.2,y:279.2}).wait(1).to({graphics:mask_graphics_5,x:544.3,y:301.8}).wait(1).to({graphics:mask_graphics_6,x:545.4,y:324.3}).wait(1).to({graphics:mask_graphics_7,x:546.6,y:346.9}).wait(1).to({graphics:mask_graphics_8,x:547.7,y:369.5}).wait(1).to({graphics:mask_graphics_9,x:548.8,y:392}).wait(1).to({graphics:mask_graphics_10,x:549.9,y:414.6}).wait(1).to({graphics:mask_graphics_11,x:551,y:437.1}).wait(1).to({graphics:mask_graphics_12,x:552.2,y:459.7}).wait(1).to({graphics:mask_graphics_13,x:553.3,y:482.3}).wait(1).to({graphics:mask_graphics_14,x:554.4,y:504.8}).wait(12));
	...
	this.instance_2 = new lib.补间77("synched",0);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance},{t:this.duilian_right}]}).to({state:[{t:this.instance_1},{t:this.instance},{t:this.duilian_right}]},4).to({state:[{t:this.instance_1},{t:this.instance},{t:this.duilian_right}]},10).to({state:[{t:this.instance_2}]},2).to({state:[{t:this.instance_3}]},9).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(16).to({_off:false},0).to({_off:true,x:721.8},9).wait(1));

	// hover_left (mask)
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	var mask_1_graphics_4 = new cjs.Graphics().p("Ar2JhIAAzBIXuAAIAATBg");
	var mask_1_graphics_5 = new cjs.Graphics().p("Ar6NeIAA67IX1AAIAAa7g");
	var mask_1_graphics_6 = new cjs.Graphics().p("Ar9RcMAAAgi3IX7AAMAAAAi3g");
	var mask_1_graphics_7 = new cjs.Graphics().p("AsAVZMAAAgqxIYBAAMAAAAqxg");
	var mask_1_graphics_8 = new cjs.Graphics().p("AsDZXMAAAgytIYHAAMAAAAytg");
	var mask_1_graphics_9 = new cjs.Graphics().p("AsGdUMAAAg6oIYNAAMAAAA6og");
	var mask_1_graphics_10 = new cjs.Graphics().p("EgMKAhSMAAAhCjIYVAAMAAABCjg");
	var mask_1_graphics_11 = new cjs.Graphics().p("EgMNAlQMAAAhKfIYbAAMAAABKfg");
	var mask_1_graphics_12 = new cjs.Graphics().p("EgMQApNMAAAhSZIYhAAMAAABSZg");
	var mask_1_graphics_13 = new cjs.Graphics().p("EgMTAtLMAAAhaVIYnAAMAAABaVg");
	var mask_1_graphics_14 = new cjs.Graphics().p("EgMWAxIMAAAhiQIYuAAMAAABiQg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(4).to({graphics:mask_1_graphics_4,x:92,y:279.9}).wait(1).to({graphics:mask_1_graphics_5,x:92.3,y:305.3}).wait(1).to({graphics:mask_1_graphics_6,x:92.7,y:330.6}).wait(1).to({graphics:mask_1_graphics_7,x:93,y:356}).wait(1).to({graphics:mask_1_graphics_8,x:93.3,y:381.4}).wait(1).to({graphics:mask_1_graphics_9,x:93.6,y:406.7}).wait(1).to({graphics:mask_1_graphics_10,x:93.9,y:432.1}).wait(1).to({graphics:mask_1_graphics_11,x:94.3,y:457.4}).wait(1).to({graphics:mask_1_graphics_12,x:94.6,y:482.8}).wait(1).to({graphics:mask_1_graphics_13,x:94.9,y:508.2}).wait(1).to({graphics:mask_1_graphics_14,x:95.2,y:533.5}).wait(12));

	// duilian_left
	this.duilian_left = new lib.duilian_left();
	this.duilian_left.setTransform(88,506,1,1,0,0,0,72,287);

	this.duilian_left.mask = mask_1;

	this.timeline.addTween(cjs.Tween.get(this.duilian_left).wait(16).to({x:-72},9).wait(1));

	// huhuan
	this.instance_4 = new lib.result_b_3();
	this.instance_4.setTransform(333,1173);

	this.instance_5 = new lib.补间68("synched",0);
	this.instance_5.setTransform(465,1194);
	this.instance_5._off = true;

	this.instance_6 = new lib.补间69("synched",0);
	this.instance_6.setTransform(465,960);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_4}]}).to({state:[{t:this.instance_5}]},4).to({state:[{t:this.instance_6}]},10).to({state:[{t:this.instance_6}]},2).to({state:[{t:this.instance_5}]},9).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(4).to({_off:false},0).to({_off:true,y:960},10).wait(2).to({_off:false,y:1194},9).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(4).to({_off:false},10).wait(2).to({startPosition:0},0).to({_off:true,y:1194},9).wait(1));

	// bufu
	this.instance_7 = new lib.result_b_2();
	this.instance_7.setTransform(42,1173);

	this.instance_8 = new lib.补间70("synched",0);
	this.instance_8.setTransform(174,1186);
	this.instance_8._off = true;

	this.instance_9 = new lib.补间71("synched",0);
	this.instance_9.setTransform(174,957);
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_7}]}).to({state:[{t:this.instance_8}]},4).to({state:[{t:this.instance_9}]},10).to({state:[{t:this.instance_9}]},2).to({state:[{t:this.instance_8}]},9).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(4).to({_off:false},0).to({_off:true,y:957},10).wait(2).to({_off:false,y:1186},9).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(4).to({_off:false},10).wait(2).to({startPosition:0},0).to({_off:true,y:1186},9).wait(1));

	// more
	this.instance_10 = new lib.补间66("synched",0);
	this.instance_10.setTransform(323.5,1188);
	this.instance_10._off = true;

	this.instance_11 = new lib.补间67("synched",0);
	this.instance_11.setTransform(323.5,850);
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(4).to({_off:false},0).to({_off:true,y:850},10).wait(2).to({_off:false,y:1188},9).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(4).to({_off:false},10).wait(2).to({startPosition:0},0).to({_off:true,y:1188},9).wait(1));

	// q5people
	this.q5mans = new lib.q5mans();
	this.q5mans.setTransform(297,-208.5,1,1,0,0,0,181,208.5);

	this.timeline.addTween(cjs.Tween.get(this.q5mans).wait(4).to({y:518.5},10).wait(2).to({y:-208.5},9).wait(1));

	// lasttop
	this.instance_12 = new lib.补间72("synched",0);
	this.instance_12.setTransform(320,-89);

	this.instance_13 = new lib.补间73("synched",0);
	this.instance_13.setTransform(320,89);

	this.instance_14 = new lib.cover_bg_top();

	this.instance_15 = new lib.补间74("synched",0);
	this.instance_15.setTransform(320,89);
	this.instance_15._off = true;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_12}]}).to({state:[{t:this.instance_13}]},4).to({state:[{t:this.instance_14}]},10).to({state:[{t:this.instance_15}]},2).to({state:[{t:this.instance_12}]},9).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_12).to({_off:true,y:89},4).wait(12).to({_off:false,y:-89},9).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(16).to({_off:false},0).to({_off:true,y:-89},9).wait(1));

	// 图层 1
	this.instance_16 = new lib.cover_bg_1();

	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(26));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,-417,640,1672);
